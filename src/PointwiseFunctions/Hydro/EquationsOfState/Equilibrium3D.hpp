...
class Equilibrium3D : public EquationOfState<EquilEos::is_relativistic, 3> {
 public:
  ...
  Scalar<double> chi_from_density_and_energy(
      const Scalar<double>& rest_mass_density,
      const Scalar<double>& specific_internal_energy) const override {
    return underlying_eos_.chi_from_density_and_energy(
        rest_mass_density, specific_internal_energy);
  }
  Scalar<DataVector> chi_from_density_and_energy(
      const Scalar<DataVector>& rest_mass_density,
      const Scalar<DataVector>& specific_internal_energy) const override {
    return underlying_eos_.chi_from_density_and_energy(
        rest_mass_density, specific_internal_energy);
  }
  ...
  Scalar<DataVector> kappa_times_p_over_rho_squared_from_density_and_energy(
      const Scalar<DataVector>& rest_mass_density,
      const Scalar<DataVector>& specific_internal_energy) const override {
    return underlying_eos_
        .kappa_times_p_over_rho_squared_from_density_and_energy(
