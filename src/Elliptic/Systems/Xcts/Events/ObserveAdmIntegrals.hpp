 ...
 public:
  ...
  using argument_tags = tmpl::list<
      ...
      Xcts::Tags::ConformalChristoffelSecondKind<DataVector, 3,
                                                 Frame::Inertial>,
      ::Tags::deriv<Xcts::Tags::ConformalChristoffelSecondKind<DataVector, 3,
                                                               Frame::Inertial>,
                    tmpl::size_t<3>, Frame::Inertial>,
      ...
      gr::Tags::Lapse<DataVector>, Xcts::Tags::ConformalRicciScalar<DataVector>,
  ...
  void operator()(
    ...
    local_adm_integrals(
        ...
        longitudinal_shift_background_minus_dt_conformal_metric,
        inertial_coords, inv_jacobian, mesh, element, conformal_face_normals,
        conformal_face_normal_vectors);
