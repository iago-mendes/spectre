...
_Thread_local long int NMAX_POINT;  /**< Maximum number of points among the three 
...
/*! \name Direction-dependent Vector Labels
    ...
    integration.                                                        */
/**@{ */
_Thread_local int VXn, VXt, VXb;  
_Thread_local int MXn, MXt, MXb;  
_Thread_local int BXn, BXt, BXb;  
int EXn, EXt, EXb;  
#if DUST_FLUID == YES
...
_Thread_local int    g_maxRiemannIter;  /**< Maximum number of iterations for 
...
#if EOS == IDEAL 
 _Thread_local double g_gamma = 5./3.;
#elif EOS == ISOTHERMAL
