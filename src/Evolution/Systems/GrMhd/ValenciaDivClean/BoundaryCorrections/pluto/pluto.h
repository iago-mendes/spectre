...
#define PLUTO_VERSION  "4.4-patch4 (Jun 2026)"
...
extern _Thread_local long int NMAX_POINT;

extern _Thread_local int VXn, VXt, VXb;
extern _Thread_local int MXn, MXt, MXb;
extern _Thread_local int BXn, BXt, BXb;
...
extern _Thread_local int g_maxRiemannIter;
...
#if EOS == IDEAL
 extern _Thread_local double g_gamma;
#elif EOS == ISOTHERMAL
